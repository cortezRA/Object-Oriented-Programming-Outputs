...
public class JavaBank extends JFrame {
    ...
    private void CreateAccountJButtonActionPerformed(ActionEvent event) {
        ...
        //int emptyAccount = 11;
        	...
        	if ((noAccounts <= 9) & (Name != "") & (Accountnum != 0))  {        		
        		...
        		displayJTextArea.setText(myAccounts.get(noAccounts).getaccountname() + " " 
        		+ myAccounts.get(noAccounts).getaccountnum() + " " + myAccounts.get(noAccounts).getbalance());
        		noAccounts ++;
    ...
    private void DisplayJButtonActionPerformed(ActionEvent event) {
    	...
    	for (int i=0; i<noAccounts; i++) { 
    			...
    			//+ myAccounts[i].getaccountnum() + " " + myAccounts[i].getbalance() + "\n");
    			displayJTextArea.append(myAccounts.get(i).getaccountname() + " " 
    			+ myAccounts.get(i).getaccountnum() + " " + myAccounts.get(i).getbalance() + "\n");
